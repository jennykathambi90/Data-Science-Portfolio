...
```
## {xml_nodeset (20)}
##  [1] <div class="result-card col-sm-12 cleafix " id="30336" data-mandate ...
##  [2] <div class="result-card col-sm-12 cleafix " id="38916" data-mandate ...
##  [3] <div class="result-card col-sm-12 cleafix " id="3380706" data-manda ...
##  [4] <div class="result-card col-sm-12 cleafix " id="3380764" data-manda ...
##  [5] <div class="result-card col-sm-12 cleafix " id="3379036" data-manda ...
##  [6] <div class="result-card col-sm-12 cleafix " id="3379781" data-manda ...
##  [7] <div class="result-card col-sm-12 cleafix " id="3376549" data-manda ...
##  [8] <div class="result-card col-sm-12 cleafix " id="3377117" data-manda ...
##  [9] <div class="result-card col-sm-12 cleafix " id="3378475" data-manda ...
## [10] <div class="result-card col-sm-12 cleafix " id="37499" data-mandate ...
## [11] <div class="result-card col-sm-12 cleafix " id="37834" data-mandate ...
## [12] <div class="result-card col-sm-12 cleafix " id="3381659" data-manda ...
## [13] <div class="result-card col-sm-12 cleafix " id="4951" data-mandatet ...
## [14] <div class="result-card col-sm-12 cleafix " id="3381979" data-manda ...
## [15] <div class="result-card col-sm-12 cleafix " id="3378730" data-manda ...
## [16] <div class="result-card col-sm-12 cleafix " id="32691" data-mandate ...
## [17] <div class="result-card col-sm-12 cleafix " id="34273" data-mandate ...
## [18] <div class="result-card col-sm-12 cleafix " id="3377836" data-manda ...
## [19] <div class="result-card col-sm-12 cleafix " id="43837" data-mandate ...
## [20] <div class="result-card col-sm-12 cleafix " id="37839" data-mandate ...
```
...
```
##  [1] NA                   NA                   "Individual Listing"
##  [4] NA                   NA                   NA                  
##  [7] NA                   NA                   "Individual Listing"
## [10] NA                   NA                   NA                  
## [13] NA                   "Fit Property"       NA                  
## [16] NA                   NA                   NA                  
## [19] NA                   NA
```
...
```
##  [1] "Pam Golding Properties"           "Pam Golding Properties"          
##  [3] "Ahadi Real Estate"                "Edlon Group Limited"             
##  [5] "Arkbridge Properties Limited"     "Simkar Group Limited"            
##  [7] "Paradigm Homes & Estates Ltd"     "Pam Golding Properties"          
##  [9] "Simkar Group Limited"             "BTE Properties"                  
## [11] "Edlon Group Limited"              "Silverstone Masters Ltd"         
## [13] "HassConsult"                      "Edlon Group Limited"             
## [15] "Simkar Group Limited"             "Isebania Management Systems"     
## [17] "Coral Property International Ltd"
```
...
## Observations: 20
## Variables: 12
## $ category               <fct> ResidentialLand, ResidentialLand, Land,...
## $ label_status           <fct> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,...
## $ label_mandate_type     <fct> ForSale, ForSale, ForSale, ForSale, For...
## $ suburb                 <fct> Runda, Runda, ThikaRoad, ThikaRoad, Juj...
## $ town                   <fct> Kiambu, Kiambu, Kiambu, Kiambu, Kiambu,...
## $ listing_heading        <chr> "ResidentialLandForSaleInRunda(3KE11980...
## $ listing_description    <chr> "PamGoldingispleasedtopresentoneacrepar...
## $ area_per_square_meter  <int> 4047, 2024, 800, 210, 0, 2024, 2024, 12...
## $ listing_price_KES      <int> 80000000, 34000000, NA, 1400000, 200000...
## $ price_per_square_meter <int> NA, NA, 43750, NA, NA, NA, NA, NA, NA, ...
## $ agency_name            <fct> PamGoldingProperties, PamGoldingPropert...
## $ listing_date           <date> 2016-03-17, 2017-01-17, 2018-06-20, 20...
```
...
nairobi_land_sale_details=get_land_sale_details(region = "nairobi")
```

```
## Warning in convert_types(semi_clean_df): NAs introduced by coercion
```
...
```
##           category label_status label_mandate_type         suburb
## 1  ResidentialLand         <NA>            ForSale          Karen
## 2   CommercialLand          New            ForSale NairobiCentral
## 3   CommercialLand         <NA>            ForSale        Pangani
## 4   CommercialLand         <NA>            ForSale        Pangani
## 5             Land         <NA>            ForSale   MuthaigaArea
## 6             Land         <NA>            ForSale      Parklands
## 7  ResidentialLand         <NA>            ForSale          Kyuna
## 8   CommercialLand         <NA>            ForSale     WaiyakiWay
## 9  ResidentialLand         <NA>            ForSale      Parklands
## 10 ResidentialLand         <NA>            ForSale      Lavington
## 11 ResidentialLand         <NA>            ForSale      Lavington
## 12            Land         <NA>            ForSale       Kilimani
## 13 ResidentialLand         <NA>            ForSale          Karen
## 14 ResidentialLand         <NA>            ForSale          Karen
## 15 ResidentialLand         <NA>            ForSale          Karen
## 16 ResidentialLand         <NA>            ForSale      UpperHill
## 17  CommercialLand         <NA>            ForSale          Karen
## 18  CommercialLand         <NA>            ForSale      UpperHill
## 19 ResidentialLand         <NA>            ForSale          Runda
## 20 ResidentialLand         <NA>            ForSale          Runda
##              town
## 1         Langata
## 2         Starehe
## 3         Starehe
...
## 20         Kiambu
##                                                       listing_heading
## 1                                        Houseforsaleinkaren(PNR0019)
## 2   NairobiCBDPlotsforsale,NexttoKenindiaBuilding,NairobiCBD(KKO0028)
## 3  ResidentialPropertyforSaleonNorthViewRoad,Pangani,Pangani(KKO0004)
## 4                  AThree-StoreyBlockofFlatsforSaleinPangani(KKO0005)
## 5                    2.34acresvacantlandforsaleinMuthaiga(3KE1372303)
## 6                                      0.25AcreLandParklands(GBD0026)
## 7                                           PrimePlotInKyuna(SIM0114)
## 8                         Prime1/2AcreLandforsaleinWestlands(PHE0091)
## 9                                      LandForSaleInParklands(S43114)
## 10                                       PrimePlotInLavington(S44989)
## 11                                       PrimePlotInLavington(S48818)
## 12                                       PrimePlotInKilimani(SIM0005)
## 13                                         LandForSaleInKaren(S40925)
## 14                          ResidentialLandForSaleInKaren(3KE1500007)
## 15                          ResidentialLandForSaleInKaren(3KE3004004)
## 16                                 PrimePlotUpperHill0.9Acres(S47397)
## 17                                   Prime0.6AcrePlotInKaren(SIM0102)
## 18                                        2nd/3rdNgongAvenue(SEM0008)
## 19                          ResidentialLandForSaleInRunda(3KE1198061)
## 20                          ResidentialLandForSaleInRunda(3KE1294460)
##                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      listing_description
## 1  A5Bedroomambassadorialhouse,sittingonapproximately1acreofflatterrain.ThehouseiswithinasecuregatedcommunityinthelavishKarensuburbandisincloseproximitytoKarenHospital.Itisapproximately7000sqftandboastsaloungewithafireplace,aseparatediningroom,TVroomandstudyroom.Spaciousallen-suitebedroomswithanextrafireplaceinthemasterbedroom.Modernfullyfittedkitchenwithbreakfastareaandalargepantry.DSQfor2,ampleparkingandanexpansivelandscapedgarden.Centralsharedclubhousewithswimmingpool,Jacuzzi,saunaandgym.Borehole,backupgeneratorand24hrsecurity.
## 2                                                                                                                                                                                                                                                                                                                                                                        2adjacentplots,measuring0.38AcresintotalLocatedinNairobiCentralBusinessDistrictnexttotheKenindiaBuilding.Idealforcommercialdevelopment.AccessibleviaUtaliiStreetoffLoitaStreet.
## 3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Thisisaplotwithhousesforre-development**Askingpriceisnegotiable.
## 4                                                                                                                                                                                                                                                                                                                  Thisdevelopment,alongNorthViewRoad,inPanganiisathree-storeyedresidentialpropertywithfour(4)shops,fourty(40)one-bedroomunits,four(4)bedsitters,andtwelve(12)singleroomunits.Itsitsona0.1399-Acrepieceofland.**Askingpriceisnegotiable.
## 5                                                                                                                                                                                                                                                                    2.3AcresInMuthaigaThisprimepieceoflandistuckedawayinthehighlysoughtafterareaofMuthaiga.The2.3acresoflushgreeneryisidealfordevelopingafamilyhomeoragatedcommunityor4housesthatdisplaysstunningviewsoftheKaruraForest.Itisararefindandanopportunitynottobemissed.Callustobookaviewing
## 6                                                                                                                                                                                                                                                                                  Inafairlyflatgroundis0.25acresforsaleinparklandsjustfewmetresfromDiamondplazaandConcordiahotel,Ithasoldambassadorialhouseof5bedroomsbutitcanbephaseoutforredevelopmentofapartments.TheadvantageofthislandisitsonthefirstrowandcanbeaccessedfromWestlandsandparklands.
## 7                                                                                                                                                                                                                                                                                                  Prime0.817acreplotforredevelopmentMainelectricityandwaterconnectedtothepropertyItisarectangulargentlesloppingplotTheplothasapprovefor5townhousesItisaleaseholdwithatermof99yearsfrom1972LOCATIONINFORMATIONTheplotislocatedinagoodneighborhoodofKyuna
## 8                                                                                                                                                                                                                                                                                                                                Propertymeasures0.5AcresPropertyisLocatedAlongWaiyakiWay,beginsKiandaschoolThepropertyisidealforbuildingofApartmentsThelandisRedSoilThepropertyisFreeHoldThepropertyhaswaterandelectricityThepropertyhascleantitledeeds
## 9                                                                                                                                                                                                                                                                                          aprime0.56acrepieceoflandlocatedinParklands2ndavenue.idealfordevelopmentofhighendapartments.Thepropertyhas2oldblocksofapartmentsanditssituatednexttoOshwalacademyandclosertoWestlandsCommercialCenterandothermajorsocialamenities.AskingpriceKshsshowme.o.n.o
## 10                                                                                                                                                                                                                                                                                   Prime0.75acrecommercialplotMainelectricityandwaterconnectedtothepropertyCurrentlythepropertyhas3bedroomsoldbungalowItisrectangularinshapeItisredsoilflatplotItisafreeholdplotINFORMATIONLOCATIONTheplotislocatedalongConventDriveonly100metersfromJamesGichuruRoad.
## 11                                                                                                                                                        Prime0.75acreplotalongMuthangariRoad,
## 12                                                                                                                                                                                                                                                                                Prime0.5acreplotforredevelopmentMainelectricityandwaterconnectedtothepropertyItisarectangularflatplotTheplotisconnectedtosewerlineCurrentlythereareoldflatsinthispropertyItisafreeholdpropertyLOCATIONINFORMATIONThepropertyislocatedonThetaLaneoffLenanaRoad,Kilimani
## 13                                                                                                                                                                                                                                                                                                                                                     Prime5AcreslandattheheartoftheleafysuburbsoffKarenalongwindyridgeidealforresidential/commercialdevelopment.Thelandtouchestarmaconbothsideandithaswaterandpower.CleanTitledeed.AskingpriceKsh.320M
## 14                                                                                                                                                                                                                                                                                                                                                                                                          Thislandisidealfordevelopment,situatedinNgongviewEstateinKaren.ithastheamazingviewsofNgongHills.Itisclosetothehubandcrossroadsshoppingmalls.
## 15                                                                                                                                                                                                                                                                                                                                                                                                            Thenarrowriverbringscharactertothisvirginpeiceoflandgivingabeautifulnaturalwaterfeature.Thisacrelandwouldbeacreativedevelopersopportunity.
## 16                                                                                                                                                                                                                                                                                                                                                  LocatedinUpperhill,onElgonRoadOppositeCrownePlazaHotelandnexttoVictoriaTowers.Itisinasecurefencedarea.Idealforcommercialdevelopmentorjointventure.CleanTitleDeed.Price:Kshs.showmeSeriousBuyersOnly.
## 17                                                                                                                                                                                                                                                                                                                                                                                               Prime0.6acreplotonDagorettiRoad,KarenMainelectricityconnectedtothepropertyItisrectangularflatplotItisafreeholdpropertyVeryidealforapartmentsdevelopment
## 18                                                                                                                                                                                                                                                         Thisprimepropertyhasseveraloldbuildingsbuthasthepotentialfora30storeyResidential/Commercialdevelopment,ascanbeseenontheoppositeploton3rdNgongAvenuewherethereisa30storeybuildingunderconstruction.Theplotalsohastworoadfrontagesandchangeofuserhasbeenappliedfor.Viewingstrictlybyappointment
## 19                                                                                                                                                                                                                                                                                            PamGoldingispleasedtopresentoneacreparceloflandinRunda.SituatedalongRundaGrovethiswouldbeidealforputtingupadreamhome.Landcanalsobefurthersubdividedtoaddanotherhouse.Thisisawellpricedandcentrallylocatedpropertythatistoogoodtomiss.Callforaviewingtoday.
## 20                                                                                                                                                                                                                                                                                                                                                                                                                ThishalfacrecornerplotislocatedinRundaevergreen.Itisflatandhasredsoil.ItisastealatthispriceinRunda!Calltomakeanappointmenttoviewtoday!
##    area_per_square_meter listing_price_KES price_per_square_meter
## 1                   4047          90000000                     NA
## 2                   1619                NA                 339758
## 3                    607                NA                  98839
## 4                    567                NA                 370645
...
## 8                   2024          39000000                     NA
## 9                     NA         200000000                     NA
## 10                  3035         185000000                     NA
## 11                  3035         250000000                     NA
## 12                  2024         215000000                     NA
## 13                    NA         320000000                     NA
## 14                 10118         125000000                     NA
## 15                  4047          35000000                     NA
## 16                  3642         600000000                     NA
## 17                  2428          40000000                     NA
## 18                  8094                NA                  86484
## 19                  4047          80000000                     NA
## 20                  2024          34000000                     NA
##                     agency_name listing_date
## 1      PioneerPropertiesLimited   2018-06-04
## 2            KinyuaKoechLimited   2018-07-13
## 3            KinyuaKoechLimited   2018-07-11
## 4            KinyuaKoechLimited   2018-07-11
## 5          PamGoldingProperties   2018-07-02
## 6   GloboActBusinessDevelopment   2018-07-11
## 7            SimkarGroupLimited   2018-06-28
## 8      ParadigmHomes&EstatesLtd   2018-07-03
## 9             EdlonGroupLimited   2016-07-04
## 10           SimkarGroupLimited   2016-08-19
## 11           SimkarGroupLimited   2017-02-14
## 12           SimkarGroupLimited   2017-10-25
## 13            EdlonGroupLimited   2016-04-29
## 14         PamGoldingProperties   2016-09-07
## 15         PamGoldingProperties   2016-09-07
## 16 IntercountyPropertiesLimited   2016-11-23
## 17           SimkarGroupLimited   2018-06-02
## 18             SemaEstateAgents   2018-07-03
## 19         PamGoldingProperties   2016-03-17
## 20         PamGoldingProperties   2017-01-17
```
