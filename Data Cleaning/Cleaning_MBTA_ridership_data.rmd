...
We will do type conversions for all the columns. For the month column we will use the lubridate package and for the other columns we will apply coersions.

#### Converting all the columns except month to numeric
