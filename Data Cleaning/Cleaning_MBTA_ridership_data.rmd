...
5. Column names(variables) are stored as rows rather than as columns.
...
## 4. Gathering the columns

Observations(values) are stored as columns rather than as rows.
