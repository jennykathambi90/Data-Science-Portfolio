...
## The alignment gender **contingency table**
...
### Dropping the levels that have the lowest entries.
...
Proportions can ve presented with:

1. Contingency tables by adding a condition. The ondition can be 1 or 2, 1 represnting rows and 2 represetning columns.   
2. A conditional bar chart plotted by asigning position of the geom bar to fill.
